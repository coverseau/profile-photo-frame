...
function ppf_profile_photo_frame() {
  wp_enqueue_style('ppf-profile-photo-frame-style', plugins_url('/css/profile-photo-frame.css', __FILE__));
  wp_enqueue_script('ppf-profile-photo-frame-script', plugins_url('/js/profile-photo-frame.js', __FILE__));
